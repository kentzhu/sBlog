...
KE.plugin['emoticons'] = {
    ...
    click : function(id) {
        var emoticonTable = [
            ...
            ['07.gif','08.gif','09.gif','10.gif','11.gif','12.gif'],
            ...
            ['31.gif','32.gif','33.gif','34.gif','35.gif','36.gif']
        ];
        var cmd = 'emoticons';
        KE.util.selection(id);
        var table = KE.$$('table');
...
KE.plugin['media'] = {
    ...
    exec : function(id) {
        ...
        var html;
        if (url.match(/\.(rm|rmvb)$/i) == null) {
            html = '<embed src="' + url + '" type="video/x-ms-asf-plugin" loop="true" autostart="false" />';
        } else {
            html = '<embed src="' + url + '" type="audio/x-pn-realaudio-plugin" loop="true" autostart="false" />';
        }
        KE.util.insertHtml(id, html);
        KE.layout.hide(id);
        KE.util.focus(id);
